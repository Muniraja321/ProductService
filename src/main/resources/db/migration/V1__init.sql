...
(
    customerorders_id BINARY(16) NOT NULL,
...
ALTER TABLE customer_order_product
    ADD CONSTRAINT fk_cusordpro_on_customer_order FOREIGN KEY (customerorders_id) REFERENCES customer_orders (id);

ALTER TABLE customer_order_product
    ADD CONSTRAINT fk_cusordpro_on_product FOREIGN KEY (product_id) REFERENCES product (id);
